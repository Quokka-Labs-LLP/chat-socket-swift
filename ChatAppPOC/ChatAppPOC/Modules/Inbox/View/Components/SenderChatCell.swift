...
struct SenderChatCell: View {
    ...
    var body: some View {
        HStack(alignment: .center, spacing: 0, content: {
            ...
            .background(senderCellBackgroundColor).cornerRadius(Constants.UIConstants.chatCellCornerRadius).padding(3)
        })
        .padding(.leading, 25)
...
struct ChatCell_Previews: PreviewProvider {
    static var previews: some View {
        ...
        SenderChatCell(
            senderShouldShowHeading: false,
            senderCellMessageFont: Constants.UIConstants.defaultFont(size: .body),
            senderCellHeadingFont: Constants.UIConstants.defaultFont(size: .subHeading),
            senderCellTimeFont: Constants.UIConstants.defaultFont(size: .callout),
            senderCellFontColor: Constants.UIConstants.charcoalBlack,
            senderCellBackgroundColor: Constants.UIConstants.DesertSandColor,
            chatData: ChatDataModel(message: "Hello World", userName: "Manni", imageUrl: "", timeStamp: "10:00 AM", isMultimediaCell: nil, isSender: true))
